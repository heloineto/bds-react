...
`@bds-react/core` package exports several functions that can be used to manipulate colors
...
```tsx
import { darken, lighten } from '@bds-react/core';
...
```tsx
import { alpha } from '@bds-react/core';
...
```tsx
import { getThemeColor, useMantineTheme } from '@bds-react/core';
...
```tsx
import { getGradient, useMantineTheme } from '@bds-react/core';
...
```tsx
import { Box, isLightColor } from '@bds-react/core';
...
```tsx
import { luminance } from '@bds-react/core';
