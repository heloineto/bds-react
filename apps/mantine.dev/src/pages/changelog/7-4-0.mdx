...
All functions are available both in `@bds-react/core` (`.ts`/`.js` files) and [postcss-preset-mantine](/styles/postcss-preset) (`.css` files, requires version 1.12.0 or higher).
