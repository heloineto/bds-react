...
This guide will help you get familiar with types that `@bds-react/core` package exports.
...
```tsx
import type { ButtonProps } from '@bds-react/core';
...
```tsx
import { Group, GroupProps } from '@bds-react/core';
...
```tsx
import { Button, ButtonProps, ElementProps } from '@bds-react/core';
...
```tsx
import { ButtonProps, ElementProps } from '@bds-react/core';
...
```tsx
import { MantineTheme, useMantineTheme } from '@bds-react/core';
...
```tsx
import { MantineSize, Paper } from '@bds-react/core';
