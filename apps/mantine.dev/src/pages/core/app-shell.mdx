...
```tsx
import { AppShell, Burger } from '@bds-react/core';
...
```tsx
import { AppShell, rem } from '@bds-react/core';
...
```tsx
import { AppShell, Button } from '@bds-react/core';
import { useDisclosure } from '@mantine/hooks';
...
```tsx
import { AppShell, ScrollArea } from '@bds-react/core';
