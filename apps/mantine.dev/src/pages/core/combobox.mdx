...
```tsx
import { Combobox, useCombobox } from '@bds-react/core';
...
You can import `UseComboboxOptions` type from `@bds-react/core` package:

```tsx
import type { UseComboboxOptions } from '@bds-react/core';
```
...
You can import `ComboboxStore` type from `@bds-react/core` package:

```tsx
import type { ComboboxStore } from '@bds-react/core';
```
...
```tsx
import { Button, Combobox, useCombobox } from '@bds-react/core';
