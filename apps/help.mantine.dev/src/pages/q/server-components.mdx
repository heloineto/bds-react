...
```tsx
// ❌ This will throw an error
import { CopyButton } from '@bds-react/core';
...
<ErrorMessage error="Could not find the module 'x/node_modules/@bds-react/core/esm/components/Popover/Popover.mjs#Popover#Target' in the React Client Manifest. This is probably a bug in the React Server Components bundler." />
...
import { Popover, PopoverTarget } from '@bds-react/core';
