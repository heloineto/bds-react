...
export function useMantineTheme() {
  ...
  if (!ctx) {
    throw new Error(
      '@bds-react/core: MantineProvider was not found in component tree, make sure you have it in your app'
    );
  }
...
MantineThemeProvider.displayName = '@bds-react/core/MantineThemeProvider';
